      ...
      <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="mb-16 grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
          <div className="col-span-full lg:col-span-2">
            ...
            <p className="mb-6 text-gray-500 sm:pr-8"> Techzen excels in MERN stack, JAMstack, and Python development,
          ...
          <div>
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div>
                <Link href="#" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Services</Link>
              </div>

              <div>
                <Link href="#" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Team</Link>
              </div>
            </nav>
          </div>
          <div>
            ...
            <nav className="flex flex-col gap-4">
              <div>
                <Link href="#" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Frontend Development</Link>
              </div>

              <div>
                <Link href="#" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Backend Development</Link>
              </div>

              <div>
                <Link href="#" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">MERN Stack Development </Link>
              </div>
            </nav>
          </div>
          <div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div>
                <Link href="#" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Terms & Conditions</Link>
              </div>
