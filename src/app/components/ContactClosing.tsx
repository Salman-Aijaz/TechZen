...
const ContactClosing = () => {
  ...
  return (
    ...
    <Link href="mailto:salman333699@gmail.com" className="inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base"    >
    Let's Work
    </Link>
  </div>
  )
