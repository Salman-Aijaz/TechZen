...
const Hero = () => {
  ...
  return (
    <div className="pb-6 sm:pb-8 lg:pb-12 dark:bg-gradient-to-b dark:from-[#080735] dark:to-gray-950 ">
      <section className="flex flex-col items-center">
        ...
        >
          <h1 className="mb-8 text-4xl font-bold leading-tight dark:text-white sm:text-5xl">
