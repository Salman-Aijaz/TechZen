...
const ContactHero = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center py-20 px-8 md:px-16 bg-gray-50">
      {/* Left Text Section */}
      <div className="text-center lg:text-left mb-10 md:mb-0 md:max-w-2xl">
        <h2 className="font-bold my-4 xl:text-8xl lg:text-7xl text-6xl">
          ...
          <span className="text-yellow-700 xl:text-8xl lg:text-7xl text-6xl">Anytime!</span>
        </h2>
